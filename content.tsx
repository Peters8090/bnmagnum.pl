  ...
  privacyPolicy: {
    ...
    content: (
      <>
        ...
        <br className="no-space" />
        Administratorem Państwa danych osobowych, jest Magnum Nieruchomości
        Magdalena Czyściakow, NIP 8271403139.
        <br />
        <strong>
        ...
        <ul>
          <li>mailowo: magda@bnmagnum.pl</li>
          <li>telefonicznie: 666 098 777</li>
        </ul>
        <br />
        ...
        <br />
        Jeżeli zostaną nam udostępnione, będziemy przetwarzali Państwa
        ...
        <br className="no-space" />
        Państwa dane osobowe otrzymaliśmy od Państwa w momencie skorzystania
        przez Państwa z formularza zapytania na naszej stronie internetowej lub
        ...
        <br />
        Przetwarzanie danych osobowych nie jest związane ze zautomatyzowanym
        podejmowaniem decyzji, w tym profilowaniu.
        <br />
        ...
        <br className="no-space" />
        Podanie danych osobowych było/jest dobrowolne. Podanie wskazanie danych
        osobowych nie jest obowiązkiem ustawowym ani umownym. Brak podania
        danych w zakresie kontaktu z Państwem uniemożliwi nam kontakt zwrotny z
        Państwem i odpowiedź na zadane pytania. W przypadku braku podania numeru
        telefonu lub adres poczty elektronicznej nie będziemy mieli możliwości
        wysyłania Państwu zamówionych informacji handlowych, Newslettera lub
        opowiedzieć Państwu o naszej ofercie.
      </>
    ),
  },
  error: {
