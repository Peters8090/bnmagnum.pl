...
const getTop = function (element: any, start: any) {
...
const easeInOutCubic = function (t: any) {
...
const position = function (start: any, end: any, elapsed: any, duration: any) {
...
const smoothScroll = (url: any) => {
  return new Promise(function (resolve) {
    const id = url.substr(2);
    const el = document.getElementById(id);
    if (el) {
      smoothScroll2(el, 600, resolve, undefined);
    } else {
      smoothScroll2(0, 600, resolve, undefined);
    }
  });
};
